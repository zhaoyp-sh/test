...
World.prototype = {
    ...
    genBg: function () {
        ...
        var imgs = [
            {url: ROOT_URL+'/image/a360/1.jpg'},
            {url: ROOT_URL+'/image/a360/2.jpg'},
            {url: ROOT_URL+'/image/a360/3.jpg'},
            {url: ROOT_URL+'/image/a360/4.jpg'},
            {url: ROOT_URL+'/image/a360/5.jpg'},
            {url: ROOT_URL+'/image/a360/6.jpg'},
            {url: ROOT_URL+'/image/a360/7.jpg'},
            {url: ROOT_URL+'/image/a360/8.jpg'},
            {url: ROOT_URL+'/image/a360/9.jpg'},
            {url: ROOT_URL+'/image/a360/10.jpg'},
            {url: ROOT_URL+'/image/a360/11.jpg'},
            {url: ROOT_URL+'/image/a360/12.jpg'},
            {url: ROOT_URL+'/image/a360/13.jpg'},
            {url: ROOT_URL+'/image/a360/14.jpg'},
            {url: ROOT_URL+'/image/a360/15.jpg'},
            {url: ROOT_URL+'/image/a360/16.jpg'},
            {url: ROOT_URL+'/image/a360/17.jpg'},
            {url: ROOT_URL+'/image/a360/18.jpg'},
            {url: ROOT_URL+'/image/a360/19.jpg'},
            {url: ROOT_URL+'/image/a360/20.jpg'}
        ];
    ...
    genHouse: function () {
        var rect = {w: 2100, h: 1170};
        var imgs = [
            {url: ROOT_URL+'/image/aHouse/1.png'},
            {url: ROOT_URL+'/image/aHouse/2.png'},
            {url: ROOT_URL+'/image/aHouse/3.png'},
            {url: ROOT_URL+'/image/aHouse/4.png'},
            {url: ROOT_URL+'/image/aHouse/5.png'},
            {url: ROOT_URL+'/image/aHouse/6.png'},
            {url: ROOT_URL+'/image/aHouse/7.png'},
            {url: ROOT_URL+'/image/aHouse/8.png'},
            {url: ROOT_URL+'/image/aHouse/9.png'},
            {url: ROOT_URL+'/image/aHouse/10.png'},
            {url: ROOT_URL+'/image/aHouse/11.png'},
            {url: ROOT_URL+'/image/aHouse/12.png'},
            {url: ROOT_URL+'/image/aHouse/13.png'},
            {url: ROOT_URL+'/image/aHouse/14.png'},
            {url: ROOT_URL+'/image/aHouse/15.png'},
            {url: ROOT_URL+'/image/aHouse/16.png'},
            {url: ROOT_URL+'/image/aHouse/17.png'},
            {url: ROOT_URL+'/image/aHouse/18.png'},
            {url: ROOT_URL+'/image/aHouse/19.png'},
            {url: ROOT_URL+'/image/aHouse/20.png'},
        ];
    ...
    genCover: function () {
        ...
        ps[0].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(0)
            }
        });
        ps[1].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(1)
            }
        });
        ...
        ps[3].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(3)
            }
        });
        ps[4].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(4)
            }
        });
        ps[5].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(5)
            }
        });
        ps[6].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(6)
            }
        });
        ps[7].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(7)
            }
        });
        ps[8].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(8)
            }
        });
        ps[9].on("touchstart", function () {
            if (!that.isDrag) {
                _s.lookDetail(9)
            }
        });
